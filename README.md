...
| Pokemon: Let's Go, Eevee! | `0100187003A36000` | `5831EC64D6B696FD` (✝️, v2, 1.0.2) | 🟡 |  |
| Pokemon: Let's Go, Pikachu! | `010003F003A34000` | `C208DB6A4EF4361F` (✝️, v2, 1.0.2) | 🟡 |  |
...
| Rad Rogers: Radical Edition | `010000600CD54000` | `78885A1CA987C04C` (❌, v2, 1.2.0) | 🔵 |  |
