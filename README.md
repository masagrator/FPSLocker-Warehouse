...
<details>
<summary>List of 30 FPS locked games (1265 titles)</summary>
<h6>
...
| ABYSS SEEKER――What Do You See Deep in Abyss | `01003990220BE000` | `820EF220126FF10A` ([✅](SaltySD/plugins/FPSLocker/patches/01003990220BE000/820EF220126FF10A.yaml), v2, 1.3.0.105) | ~~[🛑](#🛑)~~ |
...
| Achilles: Survivor | `0100CD6023C84000` | `4F426502A0CF85FD` ([✅](SaltySD/plugins/FPSLocker/patches/0100CD6023C84000/4F426502A0CF85FD.yaml), v2, 1.0.2) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| Astor: Blade of the Monolith | `01001D00186E8000` | `E2AFE5A73F5C0803` ([✅](SaltySD/plugins/FPSLocker/patches/01001D00186E8000/E2AFE5A73F5C0803.yaml), v3, 1.0.3) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| ユミアのアトリエ | `0100315020570000` | `63ABCDCCCDF0B482` (❌📌, v14, 1.7.0) |  |
...
| Bang-On Balls: Chronicles | `010081E01A45C000` | `36C7E946E6C11C8E` ([✅](SaltySD/plugins/FPSLocker/patches/010081E01A45C000/36C7E946E6C11C8E.yaml), v5, 1.0.5) | ~~[📏](#📏)[🔧](#🔧)~~ | 
...
| Becastled | `010066C024AA8000` | `FCFAE709261C279C` ([✅](SaltySD/plugins/FPSLocker/patches/010066C024AA8000/FCFAE709261C279C.yaml), v6, 1.6) | ~~[📏](#📏)~~ |
...
| Bendy and the Ink Machine | `0100D4C00C6C0000` | `8852A1C8D61310B9` (◯, v4, 2.1.0a) |  |
| Bendy and the Ink Machine `US/JP` | `010074500BBC4000` | `4FF3BB3E51E4B4B7` (◯, v5, 2.1.0a) |  |
...
| Biomutant | `01004BA017CD6000` | `5BE02E1373BDE2CC` ([✅](SaltySD/plugins/FPSLocker/patches/01004BA017CD6000/5BE02E1373BDE2CC.yaml), v2, 1.0.2) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| Biped 2 | `01004240237F6000` | `5491941E1D0B18C2` (◯, v6, 2.0.1) |  |
...
| Bloodstained: Ritual of the Night | `0100BF500207C000` | `461B14E505AB9555` ([✅](SaltySD/plugins/FPSLocker/patches/0100BF500207C000/461B14E505AB9555.yaml), v13, 1.60) | ~~[⚔️](#⚔️)[📏](#📏)[🔧](#🔧)~~ |
...
| Boti: Byteland Overclocked | `0100B7C01D480000` | `8A942A9E838E5083` ([✅](SaltySD/plugins/FPSLocker/patches/0100B7C01D480000/8A942A9E838E5083.yaml), v3, 1.0.3) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| Bum Simulator | `01008E101E868000` | `CE6953FB28A66265` ([✅](SaltySD/plugins/FPSLocker/patches/01008E101E868000/CE6953FB28A66265.yaml), v3, 1.0.3) | ~~[🔧](#🔧)~~ |
...
| Chernobylite | `01000AB01F9C0000` | `657F40EEBD955F31` ([✅](SaltySD/plugins/FPSLocker/patches/01000AB01F9C0000/657F40EEBD955F31.yaml), v2, 1.2) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| CRYMACHINA | `010055B01AA08000` | `E196E389FD9E0364` ([✅](SaltySD/plugins/FPSLocker/patches/010055B01AA08000/E196E389FD9E0364.yaml), v3, 1.2.0) | ~~[🔧](#🔧)~~ |
...
| DELTARUNE | `0100A0D022A68000` | `27A83C7E55BE239D` (❌, v10, 1.10) | [🔐](#🔐)[⏱️](#⏱️) |
...
| Diablo II: Resurrected | `0100726014352000` | `DB0507F36B84200A` (◯, v34, 1.0.34.0) |  |
...
| Disney Dreamlight Valley | `0100D39012C1A000` | `55EFB90985DE5C25` (◯, v63, 1.24.13) |  |
...
| DreadOut Remastered Collection | `01000B202041A000` | `1C0DA03A066F5B51` ([✅](SaltySD/plugins/FPSLocker/patches/01000B202041A000/1C0DA03A066F5B51.yaml), v2, 1.0.3) | ~~[📏](#📏)~~ |
...
| Dredge | `01008CD0172D6000` | `F716D367A6D7F5BA` ([✅](SaltySD/plugins/FPSLocker/patches/01008CD0172D6000/F716D367A6D7F5BA.yaml), v12, 1.5.3) | ~~[🛑](#🛑)~~ |
...
| Expeditions: A Mudrunner Game | `01002C101C1AA000` | `9B1B0DA68BEAA765` ([✅](SaltySD/plugins/FPSLocker/patches/01002C101C1AA000/9B1B0DA68BEAA765.yaml), v23, 1.23.0.0) | ~~[📏](#📏)~~ |
...
| Fate/Samurai Remnant | `01003AE01AA76000` | `6C46135714ABB870` ([✅](SaltySD/plugins/FPSLocker/patches/01003AE01AA76000/6C46135714ABB870.yaml), v13, 1.3.2) | ~~[🔐](#🔐)[⚔️](#⚔️)~~ |
...
| Five Nights at Freddy's: Help Wanted 2 | `010032F01F7CC000` | `DE7B50B9FEF89856` ([✅](SaltySD/plugins/FPSLocker/patches/010032F01F7CC000/DE7B50B9FEF89856.yaml), v2, 0.3) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| Garden Witch Life | `0100B6C01CDA0000` | `13824B290C931FE5` ([✅](SaltySD/plugins/FPSLocker/patches/0100B6C01CDA0000/13824B290C931FE5.yaml), v5, 1.0.5) | ~~[🔧](#🔧)~~ |
...
| Gori: Cuddly Carnage | `010000A017F96000` | `A21FFE97D09DCE4E` ([✅](SaltySD/plugins/FPSLocker/patches/010000A017F96000/A21FFE97D09DCE4E.yaml), v7, 1.0.7) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| Grand Theft Auto III | `0100C3C012718000` | `BB2DDA80E83D0B2F` ([✅](SaltySD/plugins/FPSLocker/patches/0100C3C012718000/BB2DDA80E83D0B2F.yaml), v8, 1.0.8) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
| Grand Theft Auto: San Andreas | `010065A014024000` | `B898981D361D0201` ([✅](SaltySD/plugins/FPSLocker/patches/010065A014024000/B898981D361D0201.yaml), v8, 1.0.8) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| Grounded | `01006F301AE9C000` |  `B46B22D9AC7E567B` ([✅](SaltySD/plugins/FPSLocker/patches/01006F301AE9C000/B46B22D9AC7E567B.yaml), v13, 1.13) | ~~[🔐](#🔐)[📏](#📏)~~ |
| GUNDAM BREAKER 4 | `010025C0145D4000` | `0FF5CF27929E07F9` ([✅](SaltySD/plugins/FPSLocker/patches/010025C0145D4000/0FF5CF27929E07F9.yaml), v11, 1.12.0) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| Hitman: Absolution | `010037C022390000` | `54162AA1F1F9870F` ([✅](SaltySD/plugins/FPSLocker/patches/010037C022390000/54162AA1F1F9870F.yaml), v1, 1.3.1_101097) | ~~[🔐](#🔐)[📏](#📏)~~ |
...
| Hogwarts Legacy | `0100F7E00C70E000` | `0C00FC37B0610FBD` ([✅](SaltySD/plugins/FPSLocker/patches/0100F7E00C70E000/0C00FC37B0610FBD.yaml), v5, 1.0.5) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| Horizon Chase 2 | `0100001019F6E000` | `E13F632FC2A66EEB` ([✅](SaltySD/plugins/FPSLocker/patches/0100001019F6E000/E13F632FC2A66EEB.yaml), v8, 1.6.9) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| HOT WHEELS UNLEASHED | `0100AA60136D2000` | `A7F32A28D882D046` ([✅](SaltySD/plugins/FPSLocker/patches/0100AA60136D2000/A7F32A28D882D046.yaml), v14, 1.0.14) | ~~[📏](#📏)[🔧](#🔧)~~ |
| HOT WHEELS UNLEASHED 2 | `01001BE01908C000` | `FE78C7B94C4E791A` ([✅](SaltySD/plugins/FPSLocker/patches/01001BE01908C000/FE78C7B94C4E791A.yaml), v11, 1.0.11) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| Jujutsu Kaisen Cursed Clash `GLOBAL` | `010085401A454000` | `7C724F497564C027` ([✅](SaltySD/plugins/FPSLocker/patches/010085401A454000/7C724F497564C027.yaml), v6, 1.4.0) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
| Jujutsu Kaisen Cursed Clash `US` | `010000B01A452000` | `7C724F497564C027` ([✅](SaltySD/plugins/FPSLocker/patches/010000B01A452000/7C724F497564C027.yaml), v6, 1.4.0) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
| 呪術廻戦 戦華双乱 | `01002FC012548000` | `7C724F497564C027` ([✅](SaltySD/plugins/FPSLocker/patches/01002FC012548000/7C724F497564C027.yaml), v6, 1.4.0) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| LEGO Horizon Adventures | `010073C01AF34000` | `C6F56735E3837278` ([✅](SaltySD/plugins/FPSLocker/patches/010073C01AF34000/C6F56735E3837278.yaml), v4, 1.4.0) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| LEGO Party | `0100A760232D2000` | `507203949A6D185D` (◯, v7, 1.6.46) |  |
...
| Life is Strange: Double Exposure | `0100B2301F4A8000` | `BBEA8745A7893750` ([✅](SaltySD/plugins/FPSLocker/patches/0100B2301F4A8000/BBEA8745A7893750.yaml), v3, 1.0.3) | ~~[🔧](#🔧)~~ |
...
| MEGATON MUSASHI W: WIRED | `01003EB01C2F0000` | `D152798E91A87AE7` ([✅](SaltySD/plugins/FPSLocker/patches/01003EB01C2F0000/D152798E91A87AE7.yaml), v10, 3.2.3) | ~~[🛑](#🛑)~~ |
...
| Metal Gear Solid 4: Guns of the Patriots | `010089601C4F6002` | `3F3713A6149C24FA` ([✅](SaltySD/plugins/FPSLocker/patches/010089601C4F6002/3F3713A6149C24FA.yaml), v5, 1.4.1) | ~~[🔐](#🔐)[📏](#📏)~~ |
| Metal Gear Solid 4: Guns of the Patriots `JPN` | `0100D0B01C4F4002` | `3F3713A6149C24FA` ([✅](SaltySD/plugins/FPSLocker/patches/0100D0B01C4F4002/3F3713A6149C24FA.yaml), v4, 1.4.1) | ~~[🔐](#🔐)[📏](#📏)~~ |
| Metal Gear Solid: Peace Walker | `010099801C4FA001` | `BCA1A793E41A4836` (❌, v2, 1.3.0) | [🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️)[🔢](#🔢) |
| Metal Gear Solid: Peace Walker `JPN` | `0100C6F01C4F8001` | `BCA1A793E41A4836` (❌, v2, 1.3.0) | [🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️)[🔢](#🔢) |
...
| Monster Jam Showdown | `0100CE101B698000` | `1CE1386EAF0C5EF5` ([✅](SaltySD/plugins/FPSLocker/patches/0100CE101B698000/1CE1386EAF0C5EF5.yaml), v8, 1.0.8) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| MotoGP 25 | `01006C7021024000` | `499A85D046C70186` ([✅](SaltySD/plugins/FPSLocker/patches/01006C7021024000/499A85D046C70186.yaml), v4, 1.0.4) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| NARUTO X BORUTO Ultimate Ninja STORM CONNECTIONS `EUR` | `01005A20190A6000` | `48ECE454B61412B9` (❌, v10, 1.7.0) | [🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️) |
| NARUTO X BORUTO Ultimate Ninja STORM CONNECTIONS `US` | `0100D2D0190A4000` | `48ECE454B61412B9` (❌, v10, 1.7.0) | [🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️) |
| NARUTO X BORUTO ナルティメットストームコネクションズ | `0100FA10190A0000` | `48ECE454B61412B9` (❌, v10, 1.7.0) | [🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️) |
| 나루토 X 보루토 나루티밋 스톰 커넥션즈 | `0100D010190A8000` | `48ECE454B61412B9` (❌, v10, 1.7.0) | [🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️) |
...
| NBA 2K26 | `0100CBF022E18000` | `BFCFFDC00177DA09` (◯, v10, 1.10) |  |
...
| Outlast 2 | `0100DE70085E8000` | `F18ACDA7A11CB287` ([✅](SaltySD/plugins/FPSLocker/patches/0100DE70085E8000/F18ACDA7A11CB287.yaml), v0, 1.0.0) | ~~[⚔️](#⚔️)~~ |
...
| PAC-MAN WORLD 2 Re-PAC | `0100C2801CFB8000` | `B70D6561B718C8E0` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2801CFB8000/B70D6561B718C8E0.yaml), v3, 1.0.3) <br> `0BB69E112916D851` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2801CFB8000/0BB69E112916D851.yaml), v4, 1.0.4) <br> `93E694F49029548F` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2801CFB8000/93E694F49029548F.yaml), v5, 1.0.5) | ~~[📷](#📷)~~ |
| パックマンワールド2 リ・パック | `010065A01CFB6000` | `B70D6561B718C8E0` ([✅](SaltySD/plugins/FPSLocker/patches/010065A01CFB6000/B70D6561B718C8E0.yaml), v3, 1.0.3) <br> `0BB69E112916D851` ([✅](SaltySD/plugins/FPSLocker/patches/010065A01CFB6000/0BB69E112916D851.yaml), v4, 1.0.4) <br> `93E694F49029548F` ([✅](SaltySD/plugins/FPSLocker/patches/010065A01CFB6000/93E694F49029548F.yaml), v5, 1.0.5) | ~~[📷](#📷)~~ |
| - 팩맨 월드 2 리팩<br>- 吃豆人 吃遍世界2 | `01009F201CFBC000` | `B70D6561B718C8E0` ([✅](SaltySD/plugins/FPSLocker/patches/01009F201CFBC000/B70D6561B718C8E0.yaml), v3, 1.0.3) <br> `0BB69E112916D851` ([✅](SaltySD/plugins/FPSLocker/patches/01009F201CFBC000/0BB69E112916D851.yaml), v4, 1.0.4) <br> `93E694F49029548F` ([✅](SaltySD/plugins/FPSLocker/patches/01009F201CFBC000/93E694F49029548F.yaml), v5, 1.0.5) | ~~[📷](#📷)~~ |
...
| Paradise Killer | `01007FB010DC8000` | `3C1DC69847A35C30` ([✅](SaltySD/plugins/FPSLocker/patches/01007FB010DC8000/3C1DC69847A35C30.yaml), v8, 1.3.0) | ~~[📏](#📏)~~ |
| パラダイスキラー | `0100EC5013ED2000` | `3C1DC69847A35C30` ([✅](SaltySD/plugins/FPSLocker/patches/0100EC5013ED2000/3C1DC69847A35C30.yaml), v4, 1.3.0) | ~~[📏](#📏)~~ |
...
| PowerWash Simulator | `0100926016012000` | `561B0F485E699E4E` ([✅](SaltySD/plugins/FPSLocker/patches/0100926016012000/561B0F485E699E4E.yaml), v19, 1.11.0) | ~~[🔐](#🔐)~~ |
...
| RAFT SURVIVAL SIMULATOR | `0100A0D01DB4E000` | `0050303DBCEF561D` ([✅](SaltySD/plugins/FPSLocker/patches/0100A0D01DB4E000/0050303DBCEF561D.yaml), v1, 1.0.1) | ~~[📷](#📷)~~ |
...
| REYNATIS | `010050F01DF9C000` | `5F765D2CC4CDEF1C` ([✅](SaltySD/plugins/FPSLocker/patches/010050F01DF9C000/5F765D2CC4CDEF1C.yaml), v10, 1.0.10) | ~~[📏](#📏)~~ |
...
| Rune Factory: Guardians of Azuma | `01003AF0200B0000` | `A91A871F86DE1A93` ([✅](SaltySD/plugins/FPSLocker/patches/01003AF0200B0000/A91A871F86DE1A93.yaml), v9, 1.1.4) | ~~[📏](#📏)[🔧](#🔧)~~ |
| Rune Factory: Guardians of Azuma `US` | `010022A02008C000` | `A91A871F86DE1A93` ([✅](SaltySD/plugins/FPSLocker/patches/010022A02008C000/A91A871F86DE1A93.yaml), v9, 1.1.4) | ~~[📏](#📏)[🔧](#🔧)~~ |
| Rune Factory: Guardians of Azuma `Cartridge only` | `0100CFB01CDCE000` |  `A91A871F86DE1A93` ([✅](SaltySD/plugins/FPSLocker/patches/0100CFB01CDCE000/A91A871F86DE1A93.yaml), v9, 1.1.4) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| SHADOW GENERATIONS | `01005EA01C0FC000` | `C8CDBFD621A6B29B` ([✅](SaltySD/plugins/FPSLocker/patches/01005EA01C0FC000/C8CDBFD621A6B29B.yaml), v2, 1.1.0) | ~~[🔐](#🔐)[📏](#📏)~~ |
...
| SnowRunner | `0100FBD013AB6000` | `8C7A99CBD1AEA208` ([✅](SaltySD/plugins/FPSLocker/patches/0100FBD013AB6000/8C7A99CBD1AEA208.yaml), v38, 1.0.42) | ~~[📏](#📏)~~ |
...
| SOMA | `0100927023A34000` | `AA2258B29060A289` (❌, v6, 1.6.0) | [🔐](#🔐)[⏱️](#⏱️)[🏃](#🏃) |
...
| Sonic Racing: CrossWorlds | `01006E001823C000` | `6455A932B210658F` (❌, v9, 1.41) | [🔐](#🔐)[⏱️](#⏱️)[🏃](#🏃) |
...
| SpongeBob SquarePants: The Patrick Star Game | `01008AF01AD22000` | `222C0A2546723943` ([✅](SaltySD/plugins/FPSLocker/patches/01008AF01AD22000/222C0A2546723943.yaml), v2, 1.0.2) | ~~[🏃](#🏃)~~ |
...
| Star Overdrive | `010047E01EA24000` | `6D05923E7005E182` ([✅](SaltySD/plugins/FPSLocker/patches/010047E01EA24000/6D05923E7005E182.yaml), v9, 1.0.10) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| Tales of Kenzera: TAU | `01005C7015D30000` | `9E7FB72540D748BA` ([✅](SaltySD/plugins/FPSLocker/patches/01005C7015D30000/9E7FB72540D748BA.yaml), v5, 1.5.0) | ~~[🔧](#🔧)~~ |
...
| Tales of Xillia Remastered | `0100F1101BB9E000` | `6DB62DBD1CECC235` ([✅](SaltySD/plugins/FPSLocker/patches/0100F1101BB9E000/6DB62DBD1CECC235.yaml), v3, 1.0.3) | ~~[⏱️](#⏱️)~~ |
...
| Terraformers | `0100C1B01872A000` | `54CEEEA3752EE96F` (◯, v9, 1.7.90) |  |
...
| The Hundred Line -Last Defense Academy- | `010093C0215B4000` | `D4A7205845845BCA` ([✅](SaltySD/plugins/FPSLocker/patches/010093C0215B4000/D4A7205845845BCA.yaml), v9, 1.2.1) | ~~[🔐](#🔐)~~ |
| The Hundred Line -Last Defense Academy- `US` | `0100748021808000` | `D4A7205845845BCA` ([✅](SaltySD/plugins/FPSLocker/patches/0100748021808000/D4A7205845845BCA.yaml), v8, 1.2.0) | ~~[🔐](#🔐)~~ |
| HUNDRED LINE -最終防衛学園- | `010079C01CFA6000` | `D4A7205845845BCA` ([✅](SaltySD/plugins/FPSLocker/patches/010079C01CFA6000/D4A7205845845BCA.yaml), v8, 1.2.0) | ~~[🔐](#🔐)~~ |
| 百日戰記 -最終防衛學園- | `0100D9D021782000` | `D4A7205845845BCA` ([✅](SaltySD/plugins/FPSLocker/patches/0100D9D021782000/D4A7205845845BCA.yaml), v8, 1.2.0) | ~~[🔐](#🔐)~~ |
...
| The Witcher 3: Wild Hunt - The Complete Edition `US` | `0100BFE00E9CA000` | `4BC4A8A814FD46A4` ([✅](SaltySD/plugins/FPSLocker/patches/0100BFE00E9CA000/4BC4A8A814FD46A4.yaml), v8, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/0100BFE00E9CA000/1FEE6F3F1D2A6A91.yaml), v9, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
| The Witcher 3: Wild Hunt - The Complete Edition `DE/AT` | `010076F00E9C8000` | `4BC4A8A814FD46A4` ([✅](SaltySD/plugins/FPSLocker/patches/010076F00E9C8000/4BC4A8A814FD46A4.yaml), v7, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/010076F00E9C8000/1FEE6F3F1D2A6A91.yaml), v8, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
| The Witcher 3: Wild Hunt - The Complete Edition `RO/BG/AU/ZA/NZ` | `010070A00E9CE000` | `4BC4A8A814FD46A4` ([✅](SaltySD/plugins/FPSLocker/patches/010070A00E9CE000/4BC4A8A814FD46A4.yaml), v7, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/010070A00E9CE000/1FEE6F3F1D2A6A91.yaml), v8, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
| The Witcher 3: Wild Hunt - The Complete Edition `KOR` | `010085500E9D0000` | `D27FD8A515077F34` ([✅](SaltySD/plugins/FPSLocker/patches/010085500E9D0000/D27FD8A515077F34.yaml), v7, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/010085500E9D0000/1FEE6F3F1D2A6A91.yaml), v8, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
| 《巫師 3：狂獵》－完全版 | `010019C00E9CC000` | `4BC4A8A814FD46A4` ([✅](SaltySD/plugins/FPSLocker/patches/010019C00E9CC000/4BC4A8A814FD46A4.yaml), v7, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/010019C00E9CC000/1FEE6F3F1D2A6A91.yaml), v8, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
| ウィッチャー３ ワイルドハント コンプリートエディション | `01000BB00E9D2000` | `4BC4A8A814FD46A4` ([✅](SaltySD/plugins/FPSLocker/patches/01000BB00E9D2000/4BC4A8A814FD46A4.yaml), v7, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/01000BB00E9D2000/1FEE6F3F1D2A6A91.yaml), v8, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
...
| The Witcher 3: Wild Hunt - The Complete Edition `LV/LT/EST/RU` | `0100A0800E9C4000` | `D27FD8A515077F34` ([✅](SaltySD/plugins/FPSLocker/patches/0100A0800E9C4000/D27FD8A515077F34.yaml), v7, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/0100A0800E9C4000/1FEE6F3F1D2A6A91.yaml), v8, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
...
| The Witcher 3: Wild Hunt | `0100E67012924000` | `B151A224A429F9A7` ([✅](SaltySD/plugins/FPSLocker/patches/0100E67012924000/B151A224A429F9A7.yaml), v4, 4.04b) <br> `1FEE6F3F1D2A6A91` ([✅](SaltySD/plugins/FPSLocker/patches/0100E67012924000/1FEE6F3F1D2A6A91.yaml), v5, 4.04c) | ~~[🔐](#🔐)[📏](#📏)~~ |
...
| Twilight Monk | `0100D7C021496000` | `23E85FEDEC96439C` ([✅](SaltySD/plugins/FPSLocker/patches/0100D7C021496000/23E85FEDEC96439C.yaml), v8, 1.5.1) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| VARLET | `0100BAE01EEA0000` | `56CB246F5724B3CC` ([✅](SaltySD/plugins/FPSLocker/patches/0100BAE01EEA0000/56CB246F5724B3CC.yaml), v2, 1.1.0) | ~~[🔧](#🔧)~~ |
| VARLET `Asia` | `01003E4022A1C000` | `56CB246F5724B3CC` ([✅](SaltySD/plugins/FPSLocker/patches/01003E4022A1C000/56CB246F5724B3CC.yaml), v2, 1.1.0) | ~~[🔧](#🔧)~~ |
...
| Warhammer 40,000: Boltgun | `01005FD017E60000` | `3E961285846C72A5` ([✅](SaltySD/plugins/FPSLocker/patches/01005FD017E60000/3E961285846C72A5.yaml), v6, 1.0.0.7) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| WARRIORS: Abyss | `01005AE0209A8000` | `7FB0CED6B8B51B80` ([✅](SaltySD/plugins/FPSLocker/patches/01005AE0209A8000/7FB0CED6B8B51B80.yaml), v15, 1.8.0) | ~~[🔐](#🔐)[📏](#📏)~~ |
| 無双アビス | `01000400204FE000` | `7FB0CED6B8B51B80` ([✅](SaltySD/plugins/FPSLocker/patches/01000400204FE000/7FB0CED6B8B51B80.yaml), v14, 1.8.0) | ~~[🔐](#🔐)[📏](#📏)~~ |
...
| Wobbly Life | `010039501F11C000` | `88330D25A235286F` (❌, v7, 1.1.0.0) | [🔧](#🔧) |
...
| NINJA GAIDEN: Ragebound | `0100781020710000` | `5CBAF9E303664284` ([✅](SaltySD/plugins/FPSLocker/patches/0100781020710000/5CBAF9E303664284.yaml), v7, 1.0.7) | ~~[🛑](#🛑)~~ |
| Out of Sight | `010098A02288A000` | `4F32126FBC538A68` ([✅](SaltySD/plugins/FPSLocker/patches/010098A02288A000/4F32126FBC538A68.yaml), v5, 1.0.5) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| The Long Dark | `01007A700A87C000` | `88C035C2E44076ED` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C000/88C035C2E44076ED.yaml), v12, 2.40.153678) <br> `99349B456BEA3469` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C000/99349B456BEA3469.yaml), v13, 2.51.170901) <br> `E7CBE9587EF75026` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C000/E7CBE9587EF75026.yaml), v14, 2.56.181233) <br> `CF59B702EA28D613` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C000/CF59B702EA28D613.yaml), v15, 2.57.182420) | ~~[📏](#📏)~~ |
| The Long Dark: Tales from the Far Territory Episodes 1-4 | `01007A700A87C001` | `F7A872504BDA3100` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C001/F7A872504BDA3100.yaml), v12, 2.40.153678) <br> `8CBC566AED7F1095` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C001/8CBC566AED7F1095.yaml), v13, 2.51.170901) <br> `E42215B57DAC0030` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C001/E42215B57DAC0030.yaml), v14, 2.56.181233)  <br> `C6B738030BE227F8` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C001/C6B738030BE227F8.yaml), v15, 2.57.182420) | ~~[📏](#📏)~~ |
| The Long Dark: Tales from the Far Territory Episode 5 | `01007A700A87C002` | `BC0A2FDE1DDAABFB` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C001/BC0A2FDE1DDAABFB.yaml), v14, 2.56.181233) <br> `C2E31E05632F5670` ([✅](SaltySD/plugins/FPSLocker/patches/01007A700A87C001/C2E31E05632F5670.yaml), v15, 2.57.182420) | ~~[📏](#📏)~~ |
...
| 하늘의 궤적 the 1st<br>空之軌跡 the 1st | `01001E9023920000` | `6656BA1B5B8AC30A` ([✅](SaltySD/plugins/FPSLocker/patches/01001E9023920000/6656BA1B5B8AC30A.yaml), v6, 1.0.6.1) <br> `4F4FD1AED39EB96A` ([✅](SaltySD/plugins/FPSLocker/patches/01001E9023920000/4F4FD1AED39EB96A.yaml), v7, 1.0.7) | ~~[⏱️](#⏱️)[📏](#📏)~~ |
...
| WRC 8 FIA 월드 랠리 챔피언십 | `010079500FD5C000` | `6B0B26802F0DAAAF` ([✅](SaltySD/plugins/FPSLocker/patches/010079500FD5C000/6B0B26802F0DAAAF.yaml), v1, 1.4.0) | ~~[📏](#📏)~~ |
